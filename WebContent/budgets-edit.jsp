              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="updateBudget" method="post" novalidate>
                    	
                    	<input name="budget-id" style="display:none;" value="<%=request.getAttribute("budgetsID") %>">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="<%=request.getAttribute("budgetsName") %>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_group form-control" name="budget-category">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="<%=request.getAttribute("budgetsDate") %>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="number" name="budget-frequency" data-validate-minmax="1,12"  required="required" class="form-control col-md-7 col-xs-12"
                          value="<%=request.getAttribute("budgetsFrequency") %>">
                        </div>
                      </div>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="number" name="budget-amount" required="required" class="form-control col-md-7 col-xs-12"
                          value="<%=request.getAttribute("budgetsAmount") %>">
                        </div>
                      </div>
