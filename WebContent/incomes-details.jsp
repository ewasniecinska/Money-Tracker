   ...
   <div class="right_col" role="main">
   	<div class="">
   		<div class="page-title">
	            ...
	            <h3>Incomes <small>Browse through all incomes</small></h3>
	        </div>
	 	</div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                 ...
                 <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="addIncome" method="post" novalidate>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                 ...
                 <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                 	...
                 	<% try {
                 		String query = "SELECT inc.id, inc.name, amount, date, inc.description, cat.name FROM incomes inc JOIN incomes_categories cat ON inc.category = cat.id where inc.user = " + session.getAttribute("id");
						Statement stmt=conn.createStatement();
						ResultSet rs=stmt.executeQuery(query);
						while(rs.next()) {
						%>
							...
							<td>
								<div class="button-container">
										<form action="deleteIncome" method="post">
											<input name="income-id" style="display:none;" value="<%=rs.getString("inc.id") %>">
