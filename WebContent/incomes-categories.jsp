              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="addIncomesCategory" method="post" novalidate>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="expenses-name" name="category-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="expenses-amount" name="category-description" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                  ...
                  <div class="x_content">
					...
					<tr>
						...
						<td>
							...
							<form action="getIncomesCategoryData" method="post">
								<input name="category-id" style="display:none;" value="<%=rs.getString("id") %>">
