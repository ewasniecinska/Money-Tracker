...
/**
 * Servlet implementation class BudgetCreate
 */

@WebServlet("/createBuget")
public class BudgetCreate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			String quary = "INSERT INTO budgets (name, category, start_date, frequency, budget, user) VALUES (?, ?, ?, ?, ?, ?)";
